...
_C.DATA.CHANNELS = 200
_C.DATA.TEST_SIZE = 0.9
_C.DATA.TRAIN_SIZE = 0.9
_C.DATA.SAMPLE_MODE = 'random'
_C.DATA.IGNOR_LABELS = [0]
_C.DATA.CENTER_PIXEL = True
_C.DATA.SUPERVISION = 'full'
...
_C.AUG.FLIP = False
_C.AUG.RADIATION = False
_C.AUG.MIXTURE = False
...
def update_config(config, args):
    ...
    if hasattr(args, 'sample_mode') and args.sample_mode:
        config.DATA.SAMPLE_MODE = args.sample_mode
    if hasattr(args, 'model_type') and args.model_type:
        config.MODEL.TYPE = args.model_type
    if hasattr(args, 'head_type') and args.head_type:
